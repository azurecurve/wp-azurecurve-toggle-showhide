	...
	<div id="azc-tsh-general" class="wrap">
		<fieldset>
			...
			<form method="post" action="admin-post.php">
				...
				<tr><th scope="row"><label for="width"><?php _e('Width', 'azurecurve-tsh'); ?></label></th><td>
					<input type="text" name="width" value="<?php echo esc_html( stripslashes($options['width']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default width (e.g. 65% or 500px)', 'azurecurve-tsh'); ?></p>
				</td></tr>
	...
	<div id="azc-tsh-general" class="wrap">
		<fieldset>
			...
			<form method="post" action="admin-post.php">
				...
				<tr><th scope="row"><label for="width"><?php _e('Width', 'azurecurve-tsh'); ?></label></th><td>
					<input type="text" name="width" value="<?php echo esc_html( stripslashes($options['width']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default width (e.g. 65% or 450px)', 'azurecurve-tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="border"><?php _e('Border', 'azurecurve-tsh'); ?></label></th><td>
					<input type="text" name="border" value="<?php echo esc_html( stripslashes($options['border']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default border (e.g. 1px solid #00F000)', 'azurecurve-tsh'); ?></p>
