...
function azc_toggle_show_hide($atts, $content = null) {
	...
	if (strlen($options['text_color']) > 0){
		$text_color = stripslashes($options['text_color']);
	}elseif (strlen($network_options['text_color']) > 0){
		$text_color = stripslashes($network_options['text_color']);
	}else{
		$text_color = "";
	}
	...
	if (strlen($bgtitle) > 0){ $background_title = "background: $bgtitle; "; }
	...
	$output = "<h3 class='azc_tsh_toggle$expand_active' style='$border$background_title'><a href='#' style='$title_color'>$title</a></h3><div class='azc_tsh_toggle_container$expand' style='$border$background_text$text_color'>$content</div>";
	...
	<div id="azc-tsh-general" class="wrap">
		<fieldset>
			...
			<form method="post" action="admin-post.php">
				...
				<tr><th scope="row"><label for="width"><?php _e('Text Color', 'azurecurve-tsh'); ?></label></th><td>
					<input type="text" name="text_color" value="<?php echo esc_html( stripslashes($options['text_color']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default title color (e.g. #000)', 'azurecurve-tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="bg_text"><?php _e('Text Background Color', 'azurecurve-tsh'); ?></label></th><td>
